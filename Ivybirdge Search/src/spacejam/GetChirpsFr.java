...
public class GetChirpsFr
{
	...
	//----a----a----a----a----a----a----a
		...
		//----b----b----b----b----b----b----b	
		//String searchString = "Syrie, OR climate OR army OR ISIS, OR Paris #prierpourparis OR #parisattacks OR #syria lang:fr since:2015-12-11 until:2015-12-12 -filter:retweets";
    List<Status> tweets;
    int totalTweets;
