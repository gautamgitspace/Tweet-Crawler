...
public class GetChirpsRU
{
	Twitter twitter;
	//----a----a----a----a----a----a----a
		//String searchString = "Сирия OR Putin OR Russia OR Turkey OR Сирия OR воздушные OR удары OR ISIS #syriaairstrikes OR #Russia lang:ru since:2015-12-11 until:2015-12-12 -filter:retweets";
		//----b----b----b----b----b----b----b	
	   String searchString = "Сирия, OR ISIS, OR Париж OR OR Париж OR атаки OR молиться OR #prayforparis OR #parisattacks OR #syria lang:ru since:2015-12-11 until:2015-12-12 -filter:retweets";
    List<Status> tweets;
    int totalTweets;
 ...
 ArrayList getObjList(JSONArray jarray, String prop) {
    ...
    void getNewTweets(){
        try{
            ...
            PrintWriter writer = new PrintWriter("chirps_ru_Dec11b.json", "UTF-8");
            writer.println("[");
    ...
    public static void main(String[] args) {
        GetChirpsRU TwitterGetObj = new GetChirpsRU();
        TwitterGetObj.setup();
    }
